...
const RegisterClient = () => {
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4 transition-colors duration-300">
      <Card className="w-full max-w-md border-border/50 bg-card/50 backdrop-blur-sm shadow-xl dark:shadow-2xl dark:shadow-primary/5">
        ...
        <CardContent className="grid gap-4">
          ...
          {/* Password Field */}
          <div className="grid gap-2">
            <Label htmlFor="password" title="text-sm font-medium">Password</Label>
            <div className="relative flex items-center">
